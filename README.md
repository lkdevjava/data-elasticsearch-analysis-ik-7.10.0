...
Analyzer: `data_ik_max_word` , `ik_max_word` , Tokenizer: `data_ik_smart` , `data_ik_max_word`
...
* optional 2 - use data-elasticsearch-plugin to install ( supported from version v5.5.1 ):
